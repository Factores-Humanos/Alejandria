            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                    ...
                    {isLoggedIn && (
                        <li className="nav-item">
                            <Link to="/publications">
                                <a className="nav-link" >Mis publicaciones</a>
                            </Link>
                ...
                <div className="dropdown mx-2">
                    ...
                    <ul className={`dropdown-menu ${modeDropdownOpen ? 'show' : ''}`}>
                        <li><a className="dropdown-item" href="#" onClick={() => handleThemeChange('light')}>Modo Claro</a></li>
                        <li><a className="dropdown-item" href="#" onClick={() => handleThemeChange('dark')}>Modo Oscuro</a></li>
                        <li><a className="dropdown-item" href="#" onClick={() => handleThemeChange('daltonic')}>Modo Daltonico</a></li>
                    </ul>
                </div>
                {isLoggedIn ? (
